...
repositories, please report it to us using the [Github Private vulnerability reporting tool](https://github.com/statisticsnorway/sdc-census-2021-hypercubes/security/advisories).
